...
export function MovieDetail({ movieId, isOpen, onClose }: MovieDetailProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      <DialogContent
        className="max-w-5xl max-h-[90vh] border-none text-white p-0 overflow-hidden"
      ...
      >
        ...
        {movie && !loading && (
          ...
          >
            ...
            {/* Scrollable Content */}
            <div
              className="overflow-y-auto px-8 md:px-12 py-8"
            ...
            >
              <DialogHeader className="mb-8">
                ...
                {movie.tagline && (
                  <p className="text-gray-300 italic mt-3 text-lg">
                    {movie.tagline}
                  </p>
                )}
              </DialogHeader>
              ...
              <div className="space-y-8 max-w-3xl mx-auto">
                ...
                {/* Overview */}
                <div>
                  <p className="text-gray-400 text-sm mb-3">Overview</p>
