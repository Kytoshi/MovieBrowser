...
>(({ className, children, hideCloseButton, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      {!hideCloseButton && (
        <DialogPrimitive.Close className="absolute right-4 top-4 z-20 rounded-full p-1.5 opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none bg-black/50 backdrop-blur-sm">
          <svg
...
// Visually hidden title for accessibility when title is not visible
...
DialogHiddenTitle.displayName = "DialogHiddenTitle"

// Visually hidden description for accessibility
const DialogHiddenDescription = React.forwardRef<
  React.ElementRef<typeof DialogPrimitive.Description>,
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Description>
>(({ children, ...props }, ref) => (
  <VisuallyHidden asChild>
...
DialogHiddenDescription.displayName = "DialogHiddenDescription"
